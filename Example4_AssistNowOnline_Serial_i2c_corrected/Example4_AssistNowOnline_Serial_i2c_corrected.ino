...
const char getGNSS[] = "gnss=gps,qzss,glo,bds,gal;"; // GNSS can be: gps,qzss,glo,bds,gal
...
void setup()
{
  ...
  // Attempt to initialize GNSS
  Serial.println("Attempting to begin GNSS...");
  if (myGNSS.begin(Wire, 0x42) == false) // Explicitly specify Wire and I2C address
  {
